...
public class JwtUtil {
    ...
    private static final long ACCESS_TOKEN_EXPIRATION_TIME = 30L * 60 * 1000; // 30 minutes
    private static final long REFRESH_TOKEN_EXPIRATION_TIME = 24L * 60 * 60 * 1000; // 1 day
